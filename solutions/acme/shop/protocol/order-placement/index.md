...
participants are [checkout](srn://acme/shop/checkout),
[inventory](srn://acme/shop/inventory), and
[payment](srn://acme/shop/checkout/payment); their nearest common ancestor is the
[shop](srn://acme/shop) product, which is where this directory sits. The
...
[idem-cap](srn://acme/shop/checkout/requirement/idem-cap). The protocol states
