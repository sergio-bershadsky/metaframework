...
[checkout](srn://acme/shop/checkout) takes payment. It is a projection, not a
...
[order-placement](srn://acme/shop/protocol/order-placement).
...
[order-placement](srn://acme/shop/protocol/order-placement): checkout calls it,
