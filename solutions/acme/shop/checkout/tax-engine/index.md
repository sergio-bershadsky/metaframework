...
[checkout](srn://acme/shop/checkout). It computes tax for a
[cart](srn://acme/shop/checkout/datamodel/cart@1) from a rate table versioned on
...
accessor in [tax-quoting](srn://acme/shop/checkout/protocol/tax-quoting) exists
