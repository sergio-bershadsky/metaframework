...
not depend on a network. [checkout](srn://acme/shop/checkout) calls
[tax-engine](srn://acme/shop/checkout/tax-engine) through an exported interface
...
[order-placement](srn://acme/shop/protocol/order-placement) is, rather than being
...
[checkout](srn://acme/shop/checkout), so their nearest common ancestor is
checkout, and this protocol lives in checkout's own bucket rather than at product
level.

## Contract

One function, `quote`, taking a [cart](srn://acme/shop/checkout/datamodel/cart@1)
