...
[order-request](srn://acme/shop/datamodel/order-request@1) that names it. That
...
creation time, and carries [order-line](srn://acme/shop/datamodel/order-line@1)
...
[order-placement](srn://acme/shop/protocol/order-placement) is deliberately
