...
[order-request](srn://acme/product/shop/datamodel/order-request@1) carries it on the
wire, and [order](srn://acme/product/shop/component/checkout/component/payment/datamodel/order@3) stores the
