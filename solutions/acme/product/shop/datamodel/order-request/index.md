...
call is a [cart](srn://acme/product/shop/component/checkout/datamodel/cart@1) and, if the payment
is authorized, an [order](srn://acme/product/shop/component/checkout/component/payment/datamodel/order@3).
...
[idem-cap](srn://acme/product/shop/component/checkout/requirement/idem-cap), which is where the
retention window and the conflict rules live — a schema can demand the field and
nothing more.

## Payment method

`payment` is a [payment-method](srn://acme/product/shop/datamodel/payment-method@1)
...
[psp](srn://acme/product/shop/component/checkout/component/payment/component/psp) hands back after tokenization.
