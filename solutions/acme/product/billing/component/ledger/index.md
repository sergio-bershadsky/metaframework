...
relations:
  ...
  exposes:
    ...
    - /product/billing/component/ledger/protocol/refund-request
  implements:
...
Its derived reuse list spans both products: [shop](srn://acme/product/shop) declares a
`depends-on` toward it and so does
[checkout](srn://acme/product/shop/component/checkout). Neither of those edges is authored here —
...
[0001-double-entry](srn://acme/product/billing/adr/0001-double-entry) rests on, which is
