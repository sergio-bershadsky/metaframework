...
[ledger](srn://acme/product/billing/component/ledger), where it can be enforced.
...
[reconciliation](srn://acme/product/billing/component/reconciliation) to consume. Declaring
...
[audit-trail](srn://acme/product/billing/requirement/audit-trail) satisfiable: from any
