...
[ledger-entry](srn://acme/product/billing/datamodel/ledger-entry@1) legs that sum to
...
[ledger](srn://acme/product/billing/component/ledger) may write an entry.
...
- **Event sourcing the ledger.** Rejected as the wrong tool twice over: double
  ...
  [0002-change-data-capture](srn://acme/product/shop/adr/0002-change-data-capture) had
