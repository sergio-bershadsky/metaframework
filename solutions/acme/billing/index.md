...
[shop](srn://acme/shop) did and records what it means in accounting terms.

## Components

- [ledger](srn://acme/billing/ledger) — the double-entry store, and the only
  writer of accounting truth in the solution.
- [reconciliation](srn://acme/billing/reconciliation) — a nightly job that proves
...
[payment](srn://acme/shop/checkout/payment) is the structural half of that —
...
Reuse of the ledger by [checkout](srn://acme/shop/checkout) is by reference — a
