...
[billing](srn://acme/billing). A [support agent](srn://acme/actor/support-agent)
asks for a refund on a settled order; the [ledger](srn://acme/billing/ledger)
...
Unlike [order-placement](srn://acme/shop/protocol/order-placement), this protocol
...
[audit-trail](srn://acme/billing/requirement/audit-trail) criterion about
`changed-by` satisfiable: the handle recorded on the resulting
[ledger-entry](srn://acme/billing/datamodel/ledger-entry@1) is a person, and it
