...
version: 1
title: Production
summary: One Hetzner Cloud instance in Helsinki running the hub from a Helm chart — the first environment this solution has ever had that is not somebody's laptop, and it still guarantees nothing.
status: review
...
A single Hetzner Cloud instance in **Helsinki** (`hel1`, Hetzner's Finnish
location) running [hub](srn://metaframework/product/hub) from the Helm chart
under `docker/chart/`, per
[0005-one-image-two-topologies](srn://metaframework/product/hub/adr/0005-one-image-two-topologies).
...
is the failure mode
[signoz](srn://metaframework/product/hub/component/signoz) is graded
