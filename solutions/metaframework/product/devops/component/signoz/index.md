...
[github](srn://metaframework/product/devops/component/github) it genuinely runs in
...
[0004-signoz-runs-beside-the-workload](srn://metaframework/product/devops/adr/0004-signoz-runs-beside-the-workload).
...
- an **OTLP collector**, which is the only part
  [telemetry](srn://metaframework/product/devops/component/telemetry) talks to;
...
Nothing in [devops](srn://metaframework/product/devops) may fail because SigNoz is
