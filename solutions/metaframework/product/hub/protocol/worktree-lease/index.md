...
participants:
  - alias: router
    ref: /product/hub/component/catalog-router
    role: client
  - alias: sync
    ref: /product/hub/component/repo-sync
    role: server
tags:
  - internal
  - git
...
[hub](srn://metaframework/product/hub), and it is internal: nothing outside the
...
design, and
[repo-sync](srn://metaframework/product/hub/component/repo-sync) explains why
...
[catalog-router](srn://metaframework/product/hub/component/catalog-router) can
