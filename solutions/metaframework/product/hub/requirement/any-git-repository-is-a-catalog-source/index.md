...
- **AC-4** A repository, or a branch, that holds no `solutions/` directory
  ...
  [worktree-lease](srn://metaframework/product/hub/protocol/worktree-lease) and
...
[github](srn://metaframework/product/hub/component/github) stays a coupling
...
hub's — for the same question a user asks once.
...
[0001](srn://metaframework/product/hub/adr/0001-a-worktree-per-branch) chose its
