...
relations:
  uses:
    - /product/hub/component/catalog-router
...
[hub](srn://metaframework/product/hub) needs one process to serve many, because
...
- **It obliges a change in a product this work was told not to fix.** Stated
  plainly on both
  [hub](srn://metaframework/product/hub) and
...
- **One process per repository, swapping the worktree underneath it.** Cheaper,
  ...
  [0001](srn://metaframework/product/hub/adr/0001-a-worktree-per-branch)
