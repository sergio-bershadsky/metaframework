...
relations:
  uses:
    - /product/hub/component/signoz
    - /product/hub/component/telemetry
tags:
  - hub
  - observability
---
...
([telemetry](srn://metaframework/product/hub/component/telemetry)) speaks
...
- **The decision is cheap to reverse and that is most of its justification.**
  ...
  [signoz](srn://metaframework/product/hub/component/signoz) is real at the
...
- **Nobody is paged.** There is no alerting, no on-call and no SLO — consistent
  ...
  hub is slow. Calling that monitoring would be a claim this catalog cannot
  support.
...
- **Prometheus and metrics rather than traces.** Rejected for the same reason
  ...
  [telemetry](srn://metaframework/product/hub/component/telemetry): a counter
