...
| `R_PRODUCT_ONE_COMPONENT` — product with a single component                       | ceremony: a component wearing a product's clothes                  | usually leave the name, fold the product later; a rename is a whole-subtree swap |
